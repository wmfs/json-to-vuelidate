...
const parseTemplate = (_template, data) => template(_template)(data)
    ...
    switch (attributeKey) {
      ...
      case 'requiredIf':
        result.requiredIf = validators.requiredIf(function () {
          const result = parseTemplate('${' + attributeValue + '}', this)
          return result === 'true'
        })
        break
      case 'minimum':
      ...
      case 'maximum.$':
        ...
        break
      case 'minimumDate': {
        result.minimumDate = function (value) {
          if (isNotDefined(value)) return true
          ...
          return mMin.isBefore(mValue)
        }
        break
      }
      case 'maximumDate': {
        result.maximumDate = function (value) {
          if (isNotDefined(value)) return true
